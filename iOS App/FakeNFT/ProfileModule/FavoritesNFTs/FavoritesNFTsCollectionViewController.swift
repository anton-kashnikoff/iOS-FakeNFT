...
final class FavoritesNFTsCollectionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        [activityIndicator, collectionView, label].forEach {
...
extension FavoritesNFTsCollectionViewController: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        profileViewModel.favoritesNFTs?.count ?? .zero
    }
    ...
    func collectionView(
        ...
        guard let nft = profileViewModel.favoritesNFTs?[indexPath.row] else {
            return UICollectionViewCell()
        }
