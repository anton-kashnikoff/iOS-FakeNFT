...
final class ProfileViewController: UIViewController, ProfileViewControllerProtocol {
    ...
    let profileImageView: UIImageView = {
        ...
        imageView.image = UIImage(resource: .userpicPlaceholder)
    ...
    private func updateProfileInfo() {
        ...
        guard let description = profileViewModel?.profile?.description,
        ...
        let range = NSMakeRange(.zero, attrString.length)
        ...
        attributedString.addAttribute(.link, value: website, range: NSMakeRange(.zero, attributedString.length))
...
extension ProfileViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.accessoryView = UIImageView(image: UIImage(resource: .chevronForward))
