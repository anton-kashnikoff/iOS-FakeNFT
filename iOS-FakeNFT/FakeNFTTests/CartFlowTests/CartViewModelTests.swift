...
//        router.reset()
    ...
    func testSortNFT() {
        ...
        let titleSortedItems = cartViewModel.sortNFT(items, by: .title)
        let priceSortedItems = cartViewModel.sortNFT(items, by: .price)
        let ratingSortedItems = cartViewModel.sortNFT(items, by: .rating)
